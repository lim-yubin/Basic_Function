                ...
                <div id="input-container">
                    <form id="input-body">
                        <div id="email-section">
                            ...
                            <div id='input-mail'>
                                <input type="text" id="mail" onKeyUp={onKeyUp} placeholder="이메일을 입력하세요" />
                                <FontAwesomeIcon icon={faCircleCheck} color={isChecked ? "#2289dd" : "#d3d3d3"} />
                            </div>
                            <div id={isChecked ? 'error-message' : "invalid"}>Invalid e-mail address.</div>
                        </div>
                        <div id="password-section">
                            <div className='input-title'>Password</div>
                            <div id="input-password">
                                <input type={showPw ? "text" : "password"} id="password" placeholder='비밀번호를 입력하세요' autoComplete="off" />
